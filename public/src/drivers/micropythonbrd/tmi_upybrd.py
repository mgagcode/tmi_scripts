...
class TMIMicroPyBrd(object):
    ...
    2) Get list of micropython boards,
         ...
         Note: if id is None, then the board doesn't have an id assigned to it.
               TMI expects every pyboard in the system to have a different id (integer)
    ...
    3) Set the ID of the pyboard
        ...
        Use the Command Line Interface (CLI),
         python tmi_micropython.py --port COM3 --set-id 1
    ...
    def scan_ports(self, port=None):
        ...
        for port in port_candidates:
            ...
            if success:
                ...
                self.pyb.close()
                ports.append({"port": port, "id": id, "version": TMI_VERSION})
            else:
...
def parse_args():
    ...
    if args.show_version:
        logging.info("Version {}".format(TMI_VERSION))
        sys.exit(0)
...
if __name__ == '__main__':
    ...
    #
    # see the class TMIMicroPyBrd comments for how to set the ID of a micropython board
    # Examples,
    #  python tmimicropybrd.py -l
    ...
    #
    # python tmimicropybrd.py -p COM5 -f
    #   INFO  164 open COM5
