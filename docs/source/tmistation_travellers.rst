...
Travellers are 2D bar codes printed on paper than can configure TMIStation
...
.. image:: _static/Screenshot_traveller_01.png


Pressing the `Traveller` button will pop up a new tab in the browser, similiar
to the following,

.. image:: _static/Screenshot_traveller_02.png
...
.. image:: _static/Screenshot_traveller_03.png
